		...
		<>
			<div className={style.heading}>
				...
				<form onSubmit={handleSubmit} className={style.form}>
					{isSignup && (
						<>
							<TextField onChange={handleChange} value={authFormData.firstName} name="firstName" autoFocus inputProps={{ autoCapitalize: "none" }} required variant="outlined" label="First Name" />
							<TextField onChange={handleChange} value={authFormData.lastName} name="lastName" required variant="outlined" label="Last Name" inputProps={{ autoCapitalize: "none" }} />
						</>
					)}
					<TextField onChange={handleChange} value={authFormData.emailAddress} name="emailAddress" required variant="outlined" type="email" label="Enter Email" inputProps={{ autoCapitalize: "none" }} />
					<TextField
					...
					<Button variant="contained" size="medium" sx={{ width: "100px" }} type="submit" onClick={handleSubmit}>
